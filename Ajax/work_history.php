...
<div style="width:500px; overflow:hidden">
	...
	<div class="form">
		...
		<form id="workhistory_newform" action="#" method="post">
        <input type="hidden" name="form_id" value="workhistory_newdetail" />
        <input type="hidden" name="rid" value="<?=$_GET['rid']?>" />
			...
			<div class="footer_go_back">
				...
				<span class="continue">
                    ...
                    <input type="button" onClick="submitform('<?=$_GET['rid']?>', 'workhistory_newform', 'work_msg')" value="Save changes" class="blue_button" />
                </span>
            </div>
		</form>
	</div><!-- End .form -->
