...
<div style="width:500px; overflow:hidden">
	...
	<div class="form">
		...
		foreach($sections as $section){
			...
			echo '
			<li id="recordsArray_'.$section['orderid'].'" style="overflow:hidden;cursor:move">
				'.$sec_d['section_name'].'
				<a style="padding:5px;font-size:11px;float:right;cursor:pointer" onclick="delete_section('.$section['orderid'].', '.$section['section_id'].', '.$section['resume_id'].')">
				Remove</a>
			</li>
			';
		}
        ...
        <div class="footer_go_back">
            ...
            <span class="goback"><br />
				<form>
                <input type="button" onclick="close_andrefresh(<?=$_GET['id']?>)" name="preview" class="blue_button" value="save changes" /></form>
            </span>            
        </div>
	</div><!-- End .form -->
</div>
