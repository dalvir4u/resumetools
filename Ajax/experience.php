...
<div style="width:500px; overflow:hidden">
	...
	<div class="form">
		...
		<form class="" id="experience_newform" action="#" method="post">
        <input type="hidden" name="form_id" value="experience_newdetail" />
        <input type="hidden" name="rid" value="<?=$_GET['rid']?>" />
		    <div class="onerow">
                <div class="span4">
                    <div class="input_title">Company<span style="color:red">*</span></div>
                    <div>
                        <input type="text" id="compname" name="company_name" class="input_text" />
                    </div>
                </div>
                <div class="span3">
            ...
            <div class="onerow">
                <div class="span7">
                    <div class="input_title">Position<span style="color:red">*</span></div>
                    <div>
			...
			<div class="footer_go_back">
				...
				<span class="continue">
                    ...
                    <input type="button" onClick="submiteduform('<?=$_GET['rid']?>', 'experience_newform', 'exp_msg')" value="save changes" class="blue_button" />
                </span>
            </div>
		</form>
	</div><!-- End .form -->
