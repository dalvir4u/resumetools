...
<div style="width:500px; overflow:hidden">
	...
	<div class="form">
        ...
        <input type="hidden" name="form_id" value="executive_expeditform" />
        ...
        <input type="hidden" name="id" value="<?=$_GET['id']?>" />
			<div class="onerow">
                <div class="span4">
                    ...
                    <div>
                        <input type="text" id="compname" name="company_name" value="<?=$e['company_name']?>" class="input_text" />
                    </div>
                </div>
                <div class="span3">
                    <div class="input_title">City</div>
                    <div>
                        <input type="text" name="city" value="<?=$e['city']?>" class="input_text" />
                    </div>
                </div>
                <div class="span3">
                    <div class="input_title">State</div>
                    <div>
                        <input type="text" name="state" value="<?=$e['state']?>" class="input_text" />
                    </div>
                </div>
            </div>
            <div class="onerow">
                <div class="span8">
                    ...
                    <div>
                        <input type="text" name="company_desc" value="<?=$e['company_desc']?>" class="input_text" />
                    </div>
                </div>
            </div>
            <div class="onerow">
                <div class="span8">
                    ...
                    <div>
                        <input type="text" name="position" value="<?=$e['position']?>" class="input_text" />
                    </div>
                </div>
            </div>
			<div class="onerow">
			...
			<div class="onerow">
                <div class="span10">
                    ...
                    <div>
                        <textarea name="desc" id="desc_val"><?=$e['desc']?></textarea>
                    </div>
                </div>
            </div>
			<div class="footer_go_back">
				...
				<span class="continue">
                    ...
                    <input type="button" onClick="submiteduform('<?=$e['resume_id']?>', 'executive_expform', 'exp_msg')" value="save changes" class="blue_button" />
               	</span>
            </div>            
		</form>
	</div><!-- End .form -->
