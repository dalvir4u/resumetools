...
class template extends commonClass {	
	...
	function printname($resume_id){
		...
		$out = '<div style="text-align:center; border-bottom:2px solid #01679a; padding:10px; color:#01679a; font-size:33px; font-family:Time new roman;" class="name">
	...
	function printaddress($resume_id){
		...
		$out = '<div style="text-align:center;  font-size:13px; padding:10px; font-family:Time new roman;" class="address"> 
           '.$addr;
	...
	function print_all_sections($resume_id){
		...
		foreach($res_secs as $res_sec) {
			...
			<div style="font-size:28px; text-align:center;border-bottom:2px solid #01679a; color:#01679a;" class="section_title">'.$section['section_name'];
	...
	function print_highlight($resume_id){
		...
		$thisout = '
		<div style="overflow:hidden; padding:10px 0 0;" class="highlights">
	...
	function view_all_sections($resume_id){
		...
		foreach($res_secs as $res_sec) {
			...
			$thisout .= '
			<div class="section_block" style="margin-top:13px;">
			<div style="font-size:28px; color:#01679a; text-align:center;border-bottom:2px solid #01679a;" class="section_title">'.$section['section_name'];
