...
class template extends commonClass {	
	...
	function printname($resume_id){
		...
		$out = '<div style="text-align:center; border-bottom:2px solid #000000; font-family:calibri; border-top:2px solid #000000; background-color:#cccccc; font-size:30px;" class="name">
	...
	function printaddress($resume_id){
		...
		$out = '<div style="text-align:center;font-size:15px; margin-top:1px; font-family:calibri;" class="address"> 
           '.$addr;
	...
	function print_all_sections($resume_id){
		...
		foreach($res_secs as $res_sec) {
			...
			<div style="font-size:23px; text-align:center; font-family:calibri; border-bottom:2px solid #000000; border-top:2px solid #000000;" class="section_title">'.$section['section_name'];
	...
	function print_highlight($resume_id){
		...
		$thisout = '
		<div style="overflow:hidden;margin-left:20%;" class="highlights">
