...
class template extends commonClass {	
	...
	function printname($resume_id){
		...
		$out = '<div style="text-align:left;font-size:36px;color:#019a9a; font-family:Cambria;" class="name">
	...
	function printaddress($resume_id){
		...
		$out = '<div style="text-align:left; font-size:16px; margin-top:1px; font-family:Cambria;" class="address"> 
           '.$addr;
	...
	function print_all_sections($resume_id){
		...
		foreach($res_secs as $res_sec) {
			...
			<div style="font-size:23px;color:#019a9a; margin=0px; font-family:Cambria; " class="section_title">'.$section['section_name'];
	...
	function viewname($resume_id){
		$res = $this->load_single_resume($resume_id);		
		$out = '<div style="text-align:left;font-size:36px;color:#019a9a; font-family:Cambria Math;" class="name">
           '.$res['first_name'].' '.$res['last_name'];
	...
	function viewaddress($resume_id){
		...
		$out = '<div style="text-align:left; font-size:16px; margin-top:1px;font-family:Cambria Math;" class="address"> 
           '.$addr;
	...
	function view_all_sections($resume_id){
		...
		foreach($res_secs as $res_sec) {
			...
			$thisout .= '
			<div class="section_block" style="margin-top:5px;">
			<div style="font-size:23px;color:#019a9a; margin:0px; font-family:Cambria Math;" class="section_title">'.$section['section_name'];			
