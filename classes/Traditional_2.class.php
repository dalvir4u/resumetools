...
class template extends commonClass {	
	...
	function printname($resume_id){
		...
		$out = '<div style="text-align:left; border-bottom:1px solid #000000; font-size:30px; font-family:verdana;" class="name">
	...
	function printaddress($resume_id){
		...
		if($res['zip']!="" or $res['state']!="" or $res['city']!="" or $res['state2']!=""){
			$addr .=' <br> ';
		}
		//Phone NUmber
		if($res['phone_num']!=""){
		...
		$out = '<div style="text-align:right; border-top:2px solid #000000; font-size:15px; font-family:verdana; margin-top:1px;" class="address">'
			.$addr;
	...
	function print_all_sections($resume_id){
		...
		foreach($res_secs as $res_sec) {
			...
			<div style="font-size:23px; margin:0px; border-bottom:1px solid #000000; font-family:verdana;" class="section_title">'.$section['section_name'];
			...
			<table style="width:100%">
					<tr>
						<td style="vertical-align:top; width:100%;text-align:left">
							<div><b>'.$degree.' '.$edu['grade_year'].'</b></div>
	...
	function print_executive_exp($resume_id){
		...
		<div style="overflow:hidden;" class="highlights">
			<table style="width:100%">
				<tr>
					<td style="width:100%; vertical-align:top;">
						<div><b>'.$exp['company_name'].'</b> '.$exp['city'].' '.$exp['state'].'</div>
